...
@section('page_title','Ubah Profil - Eksekutif')
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <form method="POST" action="{{route('eksekutif.profile.ubahdetail')}}">
                    @csrf
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <form method="POST" id="passFormNewUser" action="{{route('eksekutif.profile.ubahpassword')}}">
                    @csrf
                    <div class="form-group">
