...
@section('page_title','Profile - Operator')
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <form method="POST" action="{{route('operator.profile.ubahdetail')}}">
                    @csrf
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <form method="POST" id="passFormNewUser" action="{{route('operator.profile.ubahpassword')}}">
                    @csrf
                    <div class="form-group">
