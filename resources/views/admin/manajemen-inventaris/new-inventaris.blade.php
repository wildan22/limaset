...
<!-- /.card-header -->
<form id="tambahinventaris" method="POST" action="{{route('admin.inventaris.tambah')}}">
    <div class="card card-primary">
        ...
        <div class="card-body">
            ...
            <div class="form-group mb-3">
                ...
                <select name="unit" class="form-control select2" data-placeholder="Lokasi Barang" required>
                    <option value hidden disable></option>
